...
var NON_WORD_REGEXP = __webpack_require__(38)
var CAMEL_CASE_REGEXP = __webpack_require__(36)
var CAMEL_CASE_UPPER_REGEXP = __webpack_require__(37)
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_hoist_non_react_statics__ = __webpack_require__(56);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_verifyPlainObject__ = __webpack_require__(15);
...
var ReactDataGrid = __webpack_require__(46);
var schemaUtils = __webpack_require__(27);
var actions = __webpack_require__(25);
// 'HelloProps' describes the shape of props.
// State is never set so we use the 'undefined' type.
var TableDefGrid = (function (_super) {
    __extends(TableDefGrid, _super);
    function TableDefGrid() {
        ...
        _this.handleImportDataClick = _this.handleImportDataClick.bind(_this);
        _this.handleImportDataChange = _this.handleImportDataChange.bind(_this);
        return _this;
    }
    TableDefGrid.prototype.rowGetter = function (i) {
        return this.props.schema[i];
    };
    TableDefGrid.prototype.handleImportDataClick = function (event) {
        this.props.onImportCsv(this.state.importData);
    };
    TableDefGrid.prototype.handleImportDataChange = function (event) {
        this.setState({ importData: event.target.value });
    };
    TableDefGrid.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", null,
            React.createElement("textarea", { name: "importData", value: this.state.importData, onChange: this.handleImportDataChange }),
            React.createElement("button", { onClick: this.handleImportDataClick }, "Import"),
            React.createElement(ReactDataGrid, { columns: this.state.columns, rowGetter: this.rowGetter, rowsCount: this.props.schema.length, minHeight: 200 }),
            React.createElement("br", null),
            React.createElement("button", { onClick: function () { return _this.props.onAddField(0); } }, "Add")));
    };
    return TableDefGrid;
}(React.Component));
...
function mapDispatchToProps(dispatch) {
    return {
        onAddField: function (pos) {
            var fieldDef = schemaUtils.createFieldDef("1", "id1", "VARCHAR");
            dispatch(actions.addField(pos, fieldDef));
        },
        onImportCsv: function (data) {
            var fields = schemaUtils.csvToFields(data);
            for (var _i = 0, fields_1 = fields; _i < fields_1.length; _i++) {
                var fieldDef = fields_1[_i];
...
exports.TableDefGridComponent = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(TableDefGrid);
...
var initialState = [];
exports.store = Redux.createStore(reducers_1.default, initialState, window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__());
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.importCvs = function (data) { return ({
    type: 'IMPORT_CSV',
    data: data
}); };
exports.addField = function (position, fieldDef) { return ({
    type: 'ADD_FIELD',
    position: position,
    fieldDef: fieldDef
}); };
exports.modifyField = function (index, fieldDef) { return ({
    type: 'MODIFY_FIELD',
    index: index,
    fieldDef: fieldDef
}); };
...
function mainReducer(state, action) {
    ...
    switch (action.type) {
        ...
        case "ADD_FIELD":
            // Clone
            var fieldDef = Object.assign({}, action.fieldDef);
            return state.concat([fieldDef]);
        case "MODIFY_FIELD":
            return state.map(function (fieldDef, index) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var changeCase = __webpack_require__(29);
function createFieldDef(id, name, type) {
    return {
        id: id,
        name: name,
        type: type,
...
exports.createFieldDef = createFieldDef;
var columnMapping = new Array(8);
...
var columnParsers = new Array(8);
columnParsers[0] = function parseName(data) {
    return changeCase.camelCase(data);
};
columnParsers[1] = function parseType(data) {
    return data;
};
columnParsers[2] = function parseTypeModif(data) {
    return data;
};
columnParsers[3] = function parseBool(data) { return (data == 'true'); };
columnParsers[4] = columnParsers[5] = columnParsers[3];
columnParsers[6] = function (data) { return data; };
function csvToFields(data) {
...
exports.csvToFields = csvToFields;
...
exports.dot = exports.dotCase = __webpack_require__(31)
exports.swap = exports.swapCase = __webpack_require__(43)
exports.path = exports.pathCase = __webpack_require__(41)
exports.upper = exports.upperCase = __webpack_require__(2)
exports.lower = exports.lowerCase = __webpack_require__(4)
exports.camel = exports.camelCase = __webpack_require__(10)
exports.snake = exports.snakeCase = __webpack_require__(11)
exports.title = exports.titleCase = __webpack_require__(44)
exports.param = exports.paramCase = __webpack_require__(39)
exports.header = exports.headerCase = __webpack_require__(32)
exports.pascal = exports.pascalCase = __webpack_require__(40)
exports.constant = exports.constantCase = __webpack_require__(30)
exports.sentence = exports.sentenceCase = __webpack_require__(42)
exports.isUpper = exports.isUpperCase = __webpack_require__(34)
exports.isLower = exports.isLowerCase = __webpack_require__(33)
exports.ucFirst = exports.upperCaseFirst = __webpack_require__(6)
exports.lcFirst = exports.lowerCaseFirst = __webpack_require__(35)
...
var camelCase = __webpack_require__(10)
...
(function webpackUniversalModuleDefinition(root, factory) {
	if(true)
		module.exports = factory(__webpack_require__(3), __webpack_require__(9));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_PropTypes__ = __webpack_require__(14);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__verifySubselectors__ = __webpack_require__(53);
...
var TableDefGrid_1 = __webpack_require__(23);
/*
const MyTest = () => (
...
*/
var MyApp = function () { return (React.createElement(react_redux_1.Provider, { store: context.store },
    React.createElement(TableDefGrid_1.TableDefGridComponent, null))); };
