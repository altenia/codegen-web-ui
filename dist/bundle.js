...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var ReactDataGrid = __webpack_require__(5);
// 'HelloProps' describes the shape of props.
// State is never set so we use the 'undefined' type.
var TableDefGrid = (function (_super) {
    ...
    TableDefGrid.prototype.render = function () {
        return (React.createElement(ReactDataGrid, { columns: this.state.columns, rowGetter: this.rowGetter, rowsCount: this.state.rows.length, minHeight: 200 }));
    };
    return TableDefGrid;
}(React.Component));
exports.TableDefGrid = TableDefGrid;
...
var TableDefGrid_1 = __webpack_require__(3);
var MyTest = function () { return (React.createElement(Hello_1.Hello, { compiler: "TypeScript", framework: "React" })); };
var MyApp = function () { return (React.createElement(TableDefGrid_1.TableDefGrid, null)); };
